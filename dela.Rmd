...
V spodnjih tabelah so prikazane študije, njihovi avtorji, ter glavne značilnosti študije - uporabljeni podatki, cilj študije, preučevan dejavnik Parkinsonove bolezni in uporabljeni modeli strojnega učenja. Pri vsaki študiji, je prvi napisan model v stoplcu "Modeli", model, ki je dosegel najvišjo točnost in bil predstavljen kot končni releavntni model. Na spodnjem grafu lahko še vidimo točnost najboljših modelov v študijah iz tabele.
